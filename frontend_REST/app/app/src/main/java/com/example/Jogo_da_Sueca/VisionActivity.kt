...
class VisionActivity : AppCompatActivity() {
    ...
    // ComputerVision_1.2 FastAPI endpoint.
    private val wsUrl = "ws://10.225.61.214:8001/cv/stream/"
    // For emulator use: "ws://10.0.2.2:8001/cv/stream/"
        ...
        webSocket = client.newWebSocket(request, object : WebSocketListener() {
            ...
            override fun onMessage(ws: WebSocket, text: String) {
                ...
                runOnUiThread {
                    ...
                    val json = JSONObject(text)
                    val detection = json.optJSONObject("detection")
                    if (detection == null) {
                        // Ignore control messages that don't contain card data.
                        return@runOnUiThread
                    }
