...
## starting each AI player: run python3 -m src.ai_player
## to run tests do: python3 -m unittest ./tests/(test_example).py (substitute example for the correct test name)