"""SmartAgent - AI agent that plays Sueca using heuristic decision making."""
...
class SmartAgent(GameClient):
    """Heuristic smart bot with intelligent card selection"""
    ...
    def run(self):
        ...
        print(f"SmartAgent joined as {self.player_name}\n")
